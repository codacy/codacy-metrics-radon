...
class RadonSpec extends Specification {
  ...
  val expectedAStarFileMetric =
    FileMetrics(filename = "codacy/metrics/astar.py",
                complexity = Some(16),
                nrMethods = Some(28),
                lineComplexities = Set(LineComplexity(67, 2),
                                       LineComplexity(74, 2),
                                       LineComplexity(23, 1),
                                       LineComplexity(5, 1),
                                       LineComplexity(26, 1),
  ...
  val expectedRBTreeFileMetric =
    FileMetrics(filename = "codacy/metrics/rb_tree.py",
                complexity = Some(12),
                nrMethods = Some(29),
                lineComplexities = Set(LineComplexity(164, 5),
                                       LineComplexity(23, 1),
                                       LineComplexity(5, 2),
                                       LineComplexity(52, 1),
                                       LineComplexity(27, 1),
